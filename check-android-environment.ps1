...
function Show-InstallationGuide {
    Write-Host "`n📋 Android Development Setup Guide" -ForegroundColor Green
    ...
    Write-Host "   - Set ANDROID_HOME to: C:\Users\$env:USERNAME\AppData\Local\Android\Sdk"
...
if ($installedCount -lt $components.Count) {
    ...
    Write-Host ""
    Write-Host "🎉 All components are installed! You're ready to build Android apps." -ForegroundColor Green
    Write-Host ""
