<#
Packaging helper for Android client.
Usage:
    .\assemble-android.ps1 -Configuration Release -OutputPath ..\artifacts

This script looks for an APK/AAB under typical Android build outputs and copies it to the artifacts folder.
#>
param(
...
$apkPattern = "android/app/build/outputs/**/*.apk"
$aabPattern = "android/app/build/outputs/**/*.aab"

$apk = Get-ChildItem -Path $apkPattern -Recurse -ErrorAction SilentlyContinue | Where-Object { $_.Name -match "-release" } | Select-Object -Last 1
